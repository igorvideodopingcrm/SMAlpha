...
//alert(navigator.userAgent)
	...
	if ( document.URL.indexOf("page=") < 0 ) {
		if ( jQuery(".PageCours").length >=4 && jQuery(".ThemeCours").length >= 30 ) {
			jQuery(".PageCours").prepend('<img src="http://www.developpez.com/template/kit/kitplus.gif"/>');
			jQuery(".ListeCategorieCours").hide();
		} else {
			jQuery(".PageCours").prepend('<img src="http://www.developpez.com/template/kit/kitmoins.gif"/>');
		}
		...
		jQuery(".PageCours > img").click(function() {
			if( jQuery(this).attr("src") == "http://www.developpez.com/template/kit/kitplus.gif" ) {
				jQuery(this).attr("src", "http://www.developpez.com/template/kit/kitmoins.gif" );
				jQuery(this).next('a').next("ul").slideDown();
			} else {
				jQuery(this).attr("src", "http://www.developpez.com/template/kit/kitplus.gif" );
